...
exports.createAnnouncement = async (req, res) => {
    try {
        ...
        console.error(error);
        res.status(500).send({ message: "There was an error creating the announcement." });
    }
};
...
exports.getAnnouncementById = async (req, res) => {
    try {
        ...
        console.error(error);
        res.status(500).json({ message: "There was an error retrieving the announcement." });
    }
};
...
exports.updateAnnouncement = async (req, res) => {
    try {
        ...
        console.error(error);
        res.status(500).json({ message: "There was an error updating the announcement." });
    }
};
...
exports.deleteAnnouncement = async (req, res) => {
    try {
        ...
        console.error(error);
        res.status(500).json({ message: "There was an error deleting the announcement." });
    }
};
